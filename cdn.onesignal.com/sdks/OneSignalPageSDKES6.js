  ...
  function (e, t, i) {
    ...
    class m {
      ...
      static getIntegration(e) {
        return Object(n.a)(this, void 0, void 0, function* () {
          if (l.a.useSafariLegacyPush()) return c.a.Secure;
  ...
  function (e, t, i) {
    ...
    "undefined" != typeof window &&
      (function () {
        ...
        (window.OneSignal = i(28).default), s.doReplay(e);
      })();
  },
  function (e, t, i) {
    "use strict";
    ...
    const W = {
      ...
      L = { toastText: "onesignal-toast-text" },
      V = {
        allowButton: "onesignal-slidedown-allow-button",
        body: "slidedown-body",
        buttonIndicatorHolder: "onesignal-button-indicator-holder",
    ...
    class te {
      ...
      static onSubscriptionChanged_showWelcomeNotification(e) {
        return Object(d.a)(this, void 0, void 0, function* () {
          ...
          if (void 0 !== t && !0 === t.disable) return;
          if (!0 !== e) return;
          if (te.sendingOrSentWelcomeNotification) return;
          te.sendingOrSentWelcomeNotification = !0;
          const { deviceId: i } = yield M.a.getSubscription(),
            { appId: n } = yield M.a.getAppConfig();
          let o =
              void 0 !== t && void 0 !== t.title && null !== t.title
                ? t.title
                : "",
            s =
              void 0 !== t &&
    ...
    class ae {
      ...
      getDeliveryPlatform() {
        ...
        return h.a.useSafariLegacyPush()
          ? ne.SafariLegacy
          : h.a.useSafariVapidPush()
          ? ne.SafariVapid
          : e.firefox
          ? ne.Firefox
          : e.msedge
    ...
    class ce extends ae {
      ...
      serialize() {
        ...
        return (
          this.subscription &&
            ((e.identifier = h.a.useSafariLegacyPush()
    ...
    class Pe {
      ...
      unicast(e, t, i) {
        return Object(d.a)(this, void 0, void 0, function* () {
          ...
          } else E.a.debug(`[Worker Messenger] [Page -> SW] Unicasting '${e.toString()}' to service worker.`), this.directPostMessageToSW(e, t);
        });
      }
      ...
      updateBellLauncherDialogBody() {
        return OneSignal.getSubscription().then((e) => {
          ...
          if (
            ...
            e &&
              (n = `<a href="${(e =
                y.a.getOneSignalStaticResourcesUrl() +
    ...
    class Lt {
      ...
      static upsertSession(e, t, i, n, o, s) {
        return Object(d.a)(this, void 0, void 0, function* () {
          ...
          if (
            Lt.timeInSecondsBetweenTimestamps(a, r.lastDeactivatedTimestamp) <=
            e
          )
            return (
    ...
    class Vt {
          ...
          e.off(),
            ...
            e.on(Se.NotificationClicked, (e) =>
              Object(d.a)(this, void 0, void 0, function* () {
                ...
                } else yield S.a.trigger(OneSignal.EVENTS.NOTIFICATION_CLICKED, e);
              })
            ),
      ...
      installWorker() {
        return Object(d.a)(this, void 0, void 0, function* () {
          ...
          const e = Lt.getServiceWorkerHref(
              this.config,
              this.context.appConfig.appId,
              h.a.version()
            ),
      ...
      subscribeSafariPromptPermission() {
        return Object(d.a)(this, void 0, void 0, function* () {
          ...
          return this.safariPermissionPromptFailed
            ? e(`${y.a.getOneSignalApiUrl().toString()}/safari`)
            : e(
                `${y.a.getOneSignalApiUrl().toString()}/safari/apps/${
                  this.config.appId
                }`
              );
        });
        ...
        return Object(d.a)(this, void 0, void 0, function* () {
          if (
            ...
            const e = yield Ht.requestPresubscribeNotificationPermission(),
              t = e === A.Default;
            switch ((yield ue.a.triggerNotificationPermissionChanged(t), e)) {
              case A.Default:
                throw (
                  (E.a.debug(
      ...
      addSmsInputEventListeners() {
        ...
        e.addEventListener("keyup", (t) => {
          ...
          (this.smsInputFieldIsValid =
            ...
            "Enter" === t.key &&
              (null === (n = document.getElementById(V.allowButton)) ||
                void 0 === n ||
                n.click()),
      ...
      static resetInputErrorStates(e) {
        switch (e) {
          ...
          case T.Email:
            ...
            break;
          case T.SmsAndEmail:
            ti.showSmsInputError(!1), ti.showEmailInputError(!1);
        }
      }
      ...
      setFailureStateForInvalidChannelInput(e) {
        switch (e) {
          ...
          case Xt.InvalidEmail:
            ...
            break;
          case Xt.InvalidEmailAndSms:
            ti.showSmsInputError(!0), ti.showEmailInputError(!0);
        }
      }
      removeFailureState() {
        Object(X.w)("#onesignal-button-indicator-holder"),
          ...
          k.isSlidedownPushDependent(this.options.type) ||
            ti.resetInputErrorStates(this.options.type),
          (this.isShowingFailureState = !1);
      }
    ...
    class gi {
      ...
      installEventHooksForSlidedown() {
        (this.eventHooksInstalled = !0),
          ...
          OneSignal.emitter.on(ni.EVENTS.ALLOW_CLICK, () =>
            Object(d.a)(this, void 0, void 0, function* () {
    ...
    class yi {
      ...
      handleAllowForEmailType() {
        return Object(d.a)(this, void 0, void 0, function* () {
          ...
          if (!e || t) throw new ii(Xt.InvalidEmail);
          const i =
      ...
      handleAllowForSmsType() {
        return Object(d.a)(this, void 0, void 0, function* () {
          ...
          if (!e || t) throw new ii(Xt.InvalidSms);
          const i =
      ...
      handleAllowForSmsAndEmailType() {
        return Object(d.a)(this, void 0, void 0, function* () {
          const e =
            ...
            n =
              OneSignal.slidedown.channelCaptureContainer.isSmsInputFieldEmpty();
          if ((!e && !t) || (i && n)) throw new ii(Xt.InvalidEmailAndSms);
          const o =
              OneSignal.slidedown.channelCaptureContainer.getValueFromEmailInput(),
            s =
              OneSignal.slidedown.channelCaptureContainer.getValueFromSmsInput();
          if (!t) throw new ii(Xt.InvalidEmail);
          if ((i || this.updateEmail(o), !e)) throw new ii(Xt.InvalidSms);
          n || this.updateSMS(s);
        });
      }
      updateEmail(e) {
      ...
      enqueue(e) {
        this.slidedownQueue.push(e), ni.triggerSlidedownEvent(ni.EVENTS.QUEUED);
      }
      dequeue() {
    ...
    class Pi {
      ...
      static getIntegrationCapabilities(e) {
        switch (e) {
          case oi.Custom:
          case oi.WordPress:
            return { configuration: ai.JavaScript };
          default:
            return { configuration: ai.Dashboard };
        }
      }
